				...
				<div class="container" style="padding-top:20px;">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="mb-sm mt-sm"><strong>Join</strong> Now!</h2>
							<form id="contactFormAdvanced" action="<?php echo basename($_SERVER['PHP_SELF']); ?>#contact-sent" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										<div class="col-md-12">
											...
											<select data-msg-required="Please enter the subject." class="form-control" name="subject" id="subject" required>
												<option value="">...</option>
												<option value="Option 1">Standard</option>
												<option value="Option 2">Enterprise</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>Message *</label>
											<textarea maxlength="10000" data-msg-required="Please enter your message." rows="6" class="form-control" name="message" id="message" required>Company Name:

Number of Instruments in your lab:
